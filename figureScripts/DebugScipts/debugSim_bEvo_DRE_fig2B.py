...
simArryData['bij_mutCnt']   = np.array([[27],[28]])
...
selectionFile = 'D:\\Documents\\GitHub\\compEvo2d\\figureScripts\\outputs\\sim_bEvo_DRE_Fig2B\\sim_Fig2B_T1E9_stats_param_03A_DRE_bEvo_20250407_1907_selDyn.csv'
figfun.plot_selection_coeff(selectionFile,'abs')

############################################
#  Small T Simulation (1E9)
# 
#  CHECK Selection of c-mutation
#
############################################
# filepaths for loading and saving outputs
simPathsIO  = dict()
...
simArryData['nij']          = np.array([[3e8,100]])
simArryData['bij_mutCnt']   = np.array([[27,27]])
simArryData['dij_mutCnt']   = np.array([[1,1]])  
...
selectionFile = 'D:\\Documents\\GitHub\\compEvo2d\\figureScripts\\outputs\\sim_bEvo_DRE_Fig2B\\sim_Fig2B_T1E9_stats_param_03A_DRE_bEvo_20250407_1907_selDyn.csv'
figfun.plot_selection_coeff(selectionFile,'rel')

#%% Inestigation attractor and selection coefficients
#
# load data at for state space 28 to check if selection is working
...
sEst = np.log(data['p01'][1:].values/data['p01'][0:-1].values)