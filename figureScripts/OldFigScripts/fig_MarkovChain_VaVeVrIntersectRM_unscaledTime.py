...
ax1.text(-175,0.93e-4,r'(A)', fontsize = 22)
...
ax2.text(-175,0.93e-4,r'(B)', fontsize = 22)
...
# save figure
plt.tight_layout()
fig1.savefig(os.getcwd() + '/figures/Supplement/fig_MarkovChain_VaVeVrIntersection_unscaledTime.pdf')