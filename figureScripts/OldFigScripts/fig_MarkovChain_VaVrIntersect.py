...
ax1.set_ylim(0,2.52e-4)       # 1.5*max([max(va_i),max(vr_i)])
...
# annotations
ax1.plot([-83,-83],[0,1.28e-4],c="black",linewidth=2,linestyle='--')
ax1.annotate("", xy=(-89,0.8e-4), xytext=(-99,0.8e-4),arrowprops={'arrowstyle':'-|>','lw':3,'color':'blue'})
ax1.annotate("", xy=(-84,0.7e-4), xytext=(-99,0.7e-4),arrowprops={'arrowstyle':'-|>','lw':4,'color':'red'})
plt.text(-78,0.29e-4,r'$i^*=83$',fontsize = 18)
