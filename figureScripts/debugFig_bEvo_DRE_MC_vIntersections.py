...
figSavePath = os.path.join(os.getcwd(),'figures','Debug')

# filenames and paths for saving outputs
figFile     = 'fig_bEvo_DRE_MC_vIntersectionsDBG.pdf'
figDatDir   = 'dbgFig_bEvo_DRE_MC_vInt_pfix1'
paramFile   = ['evoExp_DRE_bEvo_01_parameters_DEBUG.csv','evoExp_DRE_bEvo_02_parameters_DEBUG.csv']
paramTag    = ['param_01DBG_DRE_bEvo','param_02DBG_DRE_bEvo']
