...
# annotations
ax1.plot([-91,-91],[0,1.50e-4],c="black",linewidth=2,linestyle='--')
ax1.annotate("", xy=(-91,0.6e-4), xytext=(-107,0.6e-4),arrowprops={'arrowstyle':'-|>','lw':4,'color':'blue'})
ax1.annotate("", xy=(-91,0.6e-4), xytext=(-75, 0.6e-4),arrowprops={'arrowstyle':'-|>','lw':4})
...
# annotations
ax2.plot([-86,-86],[0,1.45e-4],c="black",linewidth=2,linestyle='--')
ax2.annotate("", xy=(-91,0.8e-4), xytext=(-101,0.8e-4),arrowprops={'arrowstyle':'-|>','lw':3,'color':'blue'})
ax2.annotate("", xy=(-86,0.7e-4), xytext=(-101,0.7e-4),arrowprops={'arrowstyle':'-|>','lw':4,'color':'red'})
