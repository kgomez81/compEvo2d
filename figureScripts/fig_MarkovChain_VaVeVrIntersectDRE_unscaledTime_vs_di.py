...
ax1.text(xLb+0.02,3.7e-5,r'(A)', fontsize = 22)            
...
ax2.text(xLb+0.02,3.7e-5,r'(B)', fontsize = 22)
...
# save figure
plt.tight_layout()
fig1.savefig(os.getcwd() + '/figures/Supplement/fig_MarkovChain_VaVeVrIntersectionDRE_unscaledTime_vs_di.pdf')