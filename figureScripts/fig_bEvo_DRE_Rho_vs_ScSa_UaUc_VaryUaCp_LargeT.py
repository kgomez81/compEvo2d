...
figFile     = 'fig_bEvo_DRE_Rho_vs_ScSa_UaUc_VaryUaCp_LargeT.pdf'
figDatDir   = 'fig_bEvo_DRE_RhoUaCpLargeT_pfix2'
paramFile   = 'evoExp_DRE_bEvo_08_parameters.csv'
paramTag    = 'param_08_DRE_bEvo'
