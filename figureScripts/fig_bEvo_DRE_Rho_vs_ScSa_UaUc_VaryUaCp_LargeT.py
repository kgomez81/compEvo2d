...
figPathsIO['figFile']       = 'fig_bEvo_DRE_Rho_vs_ScSa_UaUc_VaryUaCp_LargeT.pdf'
figPathsIO['figDatDir']     = 'fig_bEvo_DRE_RhoUaCpLargeT_pfix2'
figPathsIO['paramFile']     = 'evoExp_DRE_bEvo_08_parameters.csv'
figPathsIO['paramTag']      = 'param_08_DRE_bEvo'
