...
figPathsIO['figFile']       = 'fig_bEvo_DRE_Rho_vs_ScSa_UaUc_VaryUaCp_LowAlpha.pdf'
figPathsIO['figDatDir']     = 'fig_bEvo_DRE_RhoUaCpLowAlpha_pfix2'
figPathsIO['paramFile']     = 'evoExp_DRE_bEvo_11_parameters.csv'
figPathsIO['paramTag']      = 'param_11_DRE_bEvo'
