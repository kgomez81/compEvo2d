...
mcArrayOutputPath = os.getcwd() + '\\outputs\\fig_bEvo_DRE_Rho_lower_alpha_Pfix03'
...
saveOutputsPath = mcArrayOutputPath + '/fig_bEvo_DRE_Rho_vs_eff_ScSa_and_eff_UaUc_lower_alpha_evoExp_DRE_bEvo_11_parameters.pickle'
...
fig.savefig(os.getcwd() + '/figures/MainDoc/fig_bEvo_DRE_Rho_vs_eff_ScSa_and_eff_UaUc_lower_alpha.pdf',bbox_inches='tight')
