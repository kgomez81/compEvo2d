...
figure 3 of the main text, but with reduced territory size.
"""
...
figPathsIO['figFile']       = 'fig_bEvo_DRE_Rho_vs_ScSa_UaUc_VaryUaCp_SmallT.pdf'
figPathsIO['figDatDir']     = 'fig_bEvo_DRE_RhoUaCpSmallT_pfix2'
figPathsIO['paramFile']     = 'evoExp_DRE_bEvo_07_parameters.csv'
figPathsIO['paramTag']      = 'param_07_DRE_bEvo'
