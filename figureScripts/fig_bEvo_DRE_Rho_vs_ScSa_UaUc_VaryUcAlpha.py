...
figure 3 of the main text, but we vary Uc and alpha in a grid for this plot.
"""
...
figPathsIO['figFile']       = 'fig_bEvo_DRE_Rho_vs_ScSa_UaUc_VaryUcAlpha.pdf'
figPathsIO['figDatDir']     = 'fig_bEvo_DRE_RhoUcAlpha_pfix2'
figPathsIO['paramFile']     = 'evoExp_DRE_bEvo_10_parameters.csv'
figPathsIO['paramTag']      = 'param_10_DRE_bEvo'

# specify parameters for the MC models
figModelIO = dict()
figModelIO['modelType']     = 'DRE'
figModelIO['absFitType']    = 'bEvo'
figModelIO['varNames']      = ['Uc','alpha']
figModelIO['nArry']         = 11

Uc_Bnds     = np.linspace(-3, 3, figModelIO['nArry'])
alpha_Bnds  = np.linspace(-0.01, 0.004, figModelIO['nArry'])   # cannot exceed ~O(10^-1) for pFix estimates
figModelIO['varBounds']     = [Uc_Bnds, alpha_Bnds]
