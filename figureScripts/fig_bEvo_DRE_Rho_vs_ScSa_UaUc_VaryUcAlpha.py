...
figFile     = 'fig_bEvo_DRE_Rho_vs_ScSa_UaUc_VaryUcAlpha.pdf'
figDatDir   = 'fig_bEvo_DRE_RhoUcAlpha_pfix2'
paramFile   = 'evoExp_DRE_bEvo_10_parameters.csv'
paramTag    = 'param_10_DRE_bEvo'
...
zLabels  = [("%.2f" % 10**tick) for tick in zTicks]
